...
class Overview(models.Model):
    ...
    asset_type = models.CharField(max_length=255, blank=False, default='')
    name = models.CharField(max_length=255, blank=False, default='')
    description = models.CharField(max_length=255, blank=False, default='')
    exchange = models.CharField(max_length=255, blank=False, default='')
    currency = models.CharField(max_length=255, blank=False, default='')
    sector = models.CharField(max_length=255, blank=False, default='')
    industry = models.CharField(max_length=255, blank=False, default='')
    full_time_employees = models.CharField(max_length=255, blank=False, default='')
    fiscal_year_end = models.CharField(max_length=255, blank=False, default='')
